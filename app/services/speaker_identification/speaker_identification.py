...
from app.services.embedding_protection.embedding_protection import EmbeddingProtector
...
from app.services.speaker_identification.embedding_repo import VoiceEmbeddingRepository

...
class QdrantVoiceEmbeddingRepository:
    ...
    def get_embedding(self, embedding_id: UUID) -> VoiceEmbedding | None:
        records = self.client.retrieve(
            collection_name=self.settings.embeddings_collection,
            ids=[
                self._point_id(
        ...
        return self._embedding_from_point(records[0])
    
    def rename_embedding_person(
        self,
        embedding: VoiceEmbedding,
        person_name: str,
        ...
        self.upsert_embedding(
            VoiceEmbedding(
                ...
                person_id=person_id or embedding.person_id,
    ...
    def _embedding_from_point(self, point: Any) -> VoiceEmbedding:
        ...
        return VoiceEmbedding(
            speaker_id=payload.get(SPEAKER_ID_KEY),
